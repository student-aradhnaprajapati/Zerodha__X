...
function Footer() {
    return (
        <footer style={{backgroundColor:"rgb(240, 240, 240)"}}>
            <div className='contaiiner p-5 border-top mt-5'>
                <div className='row p-3 mt-3'>
                    ...
                    <div className='col' >
                        ...
                        <br />
                        <a href='' className='text-muted' style={{textDecoration:"none"}}>Referral Programs</a>
                        <br />
                    ...
                    <div className='col'>
                        <p>Account</p>
                        <a href='' className='text-muted' style={{textDecoration:"none" }}>Open Account</a>
                        <br />
                        <a href='' className='text-muted' style={{textDecoration:"none"}}>Fund transfer</a>
                        <br />
                        <a href='' className='text-muted' style={{textDecoration:"none"}}>60 day challenges</a>
                    </div>
